...
Se quiere hallar el área debajo de la gráfica de una función (como la que se muestra en la figura \ref{fig:fig1}):
...
% TODO: Incluir ejercicios de diferenciacion logaritmica
[Incluir ejercicios de diferenciacion logaritmica]
...
\begin{theorem}
    Si $f(x)$ es una función estrictamente creciente tal que existe su inversa, entonces $f^{-1}(x)$ es una función estrictamente creciente, es decir, la inversa de una función creciente es una funcion creciente.
\end{theorem}
...
% Incluir ejercicios aqui
[Ejercicios]

% Incluir arsenal de limites hasta el momento 
[Arsenal de limites]
